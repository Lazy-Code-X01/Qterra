    ...
    <section className="bg-white py-20">
      <div className="max-w-6xl mx-auto px-6 sm:px-10 lg:px-16">
        ...
        <motion.div
          ...
          className="border-t border-b border-[#e8e8e4] py-3 mb-10"
        >
            ...
            {filtered.map((item, i) => (
              ...
              >
                <Link href={item.href} className="group flex flex-col h-full">
                  {/* Image */}
                  <div className="w-full h-[260px] rounded-xl overflow-hidden bg-[#e8e8e4] relative">
                    <Image
                      src={item.image}
                      alt={item.title}
                      fill
        ...
        >
          <Link href="/case-studies">
            <button className="inline-flex items-center gap-2 bg-qterra-black text-white font-inter font-semibold text-[14px] px-8 py-3.5 rounded-full hover:bg-forest transition-colors duration-200">
              All Recent Projects

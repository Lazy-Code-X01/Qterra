...
const tiers = [
  {
    ...
    subtitle: "Executive-level strategy design and disciplined execution — helping organizations define priorities and deliver measurable outcomes.",
    services: [
      { name: "Strategy & Transformation", desc: "Enterprise strategy design, procurement frameworks, cost optimization, and business process improvement." },
      { name: "Project Delivery & Implementation", desc: "Project and program management, governance, controls, performance monitoring, and initiative execution." },
    ],
  ...
  },
  {
    ...
    number: "02",
    Icon: Layers,
    title: "Enablement & Capability",
    subtitle: "Digital tools, AI-enabled decision support, and capability building programs that sustain and scale organizational performance.",
    services: [
      { name: "Digital Solutions & Analytics", desc: "Process automation, data analytics platforms, AI-enabled decision support, and operational performance tools." },
      { name: "Human Capital & Talent Management", desc: "Workforce planning, talent acquisition, leadership development, and HR operations support." },
      { name: "Training & Capability Building", desc: "Executive training, professional workshops, applied capability programs, and AI-driven project management." },
    ],
